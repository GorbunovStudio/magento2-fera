...
Run the historical snapshot import once per deployment environment after the package schema has been upgraded:

```bash
php bin/magento fera:reviews:backfill --page-size 100
```
