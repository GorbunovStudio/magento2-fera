# Fera Positive Review Notifications

## Purpose

Send configurable positive-review Slack notifications through a dedicated Fera notification flow while preserving existing negative-review behavior and rendering uploaded media from full URLs.
