...
- Detect review updates by comparing the current payload with the previous snapshot for `rating`, `heading`, `body`, and `media` before sending an update notification.
